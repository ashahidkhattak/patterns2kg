...
if __name__ == "__main__":
    ...
    #######NOTE: we reduced this step Step1 (pickle_to_dictionary)
    #######JAMS_pipeline.pickle_to_dictionary()
    # Step1 (dictionary_to_JAMS)
    JAMS_pipeline.pickle_to_JAMS()
    # Step2 (dictionary_to_JAMS)
    JAMS_pipeline.JAMS_to_RDF()